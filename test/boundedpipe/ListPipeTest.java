...
public class ListPipeTest {
    ...
    @Test
    public void equals_ABC6LinkedToABC6List_true() {
    ...
    @Test
    public void equals_ABC6ArrayToABC6List_true() {
    ...
    @Test
    public void hashCode_ABC6LinkedToABC6List_true() {
        Pipe<String> linkedPipe = new LinkedPipe<>(6);
        linkedPipe.append("A");
        linkedPipe.append("B");
        linkedPipe.append("C");
    ...
    @Test
    public void hashCode_ABC6ArrayToABC6List_true() {
        Pipe<String> circArrayPipe = new CircArrayPipe<>(6);
        circArrayPipe.append("A");
        circArrayPipe.append("B");
        circArrayPipe.append("C");
    ...
    @Test
    public void appendAll_DELinkedToABCList_ABCDE() {
