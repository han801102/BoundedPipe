...
public class LinkedPipeTest {
    ...
    @Test
    public void equals_ABC6ListToABC6Linked_true() {
    ...
    @Test
    public void equals_ABC6ArrayToABC6Linked_true() {
        Pipe<String> circArrayPipe = new CircArrayPipe<>(6);
        circArrayPipe.append("A");
        circArrayPipe.append("B");
        circArrayPipe.append("C");
        assertTrue(pipeABC6.equals(circArrayPipe));
    }
    ...
    @Test
    public void hashCode_ABC6ListToABC6Linked_true() {
        Pipe<String> listPipe = new ListPipe<>(6);
        listPipe.append("A");
        listPipe.append("B");
        listPipe.append("C");
    ...
    @Test
    public void hashCode_ABC6ArrayToABC6Linked_true() {
        Pipe<String> circArrayPipe = new CircArrayPipe<>(6);
        circArrayPipe.append("A");
        circArrayPipe.append("B");
        circArrayPipe.append("C");
        assertTrue(pipeABC6.hashCode() == circArrayPipe.hashCode());
    }
    ...
    @Test
    public void appendAll_DEListToABCLinked_ABCDE() {
    ...
    @Test
    public void appendAll_DEArrayToABCLinked_ABCDE() {
        Pipe<String> circArrayPipe = new CircArrayPipe<>(3);
        circArrayPipe.append("D");
        circArrayPipe.append("E");

        pipeABC6.appendAll(circArrayPipe);
        assertEquals(5, pipeABC6.length());
        assertEquals(6, pipeABC6.capacity());
        assertEquals("[A, B, C, D, E]:6", pipeABC6.toString());
    }
